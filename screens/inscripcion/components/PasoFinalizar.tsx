...
export default function PasoFinalizar({ idUsuario, onDashboard }: Props) {
  ...
  const finalizar = async () => {
    try {
      ...
      await httpClient.postAuth(
        `/api/inscripcion/finalizar/${idUsuario}`,
        {}
      );
    ...
    <View style={{ gap: 24 }}>
      ...
      >
        ...
        >
          ...
          <ThemedText style={{ fontWeight: "800" }}>{nombreCompleto}</ThemedText>
        ...
        >
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <ThemedText style={{ fontWeight: "800" }}>
                {resumen.grupo?.nombre ?? "Sin grupo"}
              </ThemedText>
              ...
              <ThemedText style={{ fontWeight: "800" }}>
                {resumen.grupo?.turno ?? "-"} · {resumen.grupo?.horario ?? "-"}
              </ThemedText>
            </View>
          </View>
        </View>
